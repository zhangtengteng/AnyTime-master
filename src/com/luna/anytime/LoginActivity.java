...
public class LoginActivity extends AnyTimeActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// AVAnalytics.trackAppOpened(getIntent()); //���ٴ򿪵ķ���
...
//		AVService.initPushService(this);
		...
		userNameEditText.setText("18021832062");
		userPasswordEditText.setText("888888");
//		if (getUserId() != null) {
...
//		}
	...
	OnClickListener loginListener = new OnClickListener() {
		...
		public void onClick(View arg0) {
			...
			progressDialogShow();
			AVUser.loginByMobilePhoneNumberInBackground(username, password(), new LogInCallback() {
	...
	OnClickListener forgetPasswordListener = new OnClickListener() {
		...
		@Override
		public void onClick(View arg0) {
			Intent forgetPasswordIntent = new Intent(activity,
